...
import os
from data_utils.da_metrics_utils import MODEL_NAMES, MODEL_500_NAMES, MODEL_1000_NAMES, MODEL_1000_EVAL_NAMES
...
model_1000_val_dict = {_[0]: _[1] for _ in MODEL_1000_EVAL_NAMES}
...
def accuracy_vel_collection(args, trained_model_dict: dict):
    # +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    # +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    # if args.exp_name is None:
    args.exp_name = args.train_file_name + '.models'
...
if __name__ == '__main__':
    ...
    for train_file_name in train_file_names:
        ...
        for eval_file_name in dev_file_names:
            ...
            orig_acc, drop_acc, beta_acc = accuracy_vel_collection(args=args, trained_model_dict=model_1000_val_dict)
